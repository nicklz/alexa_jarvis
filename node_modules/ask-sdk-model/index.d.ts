...
export declare namespace services.datastore.v1 {
     ...
     * @enum
     */
    type DispatchResultType = 'SUCCESS' | 'INVALID_DEVICE' | 'DEVICE_UNAVAILABLE' | 'DEVICE_PERMANENTLY_UNAVAILABLE' | 'CONCURRENCY_ERROR' | 'INTERNAL_ERROR';
}
export declare namespace services.datastore.v1 {
    /**
     *
...
export declare namespace services.datastore {
    ...
    */
    class DatastoreServiceClient extends BaseServiceClient {
         ...
         */
        callCommandsV1(authorization: string, commandsRequest: services.datastore.v1.CommandsRequest): Promise<ApiResponse>;
        /**
         * Send DataStore commands to Alexa device.
         * @param {string} authorization
         * @param {services.datastore.v1.CommandsRequest} commandsRequest
         */
        commandsV1(authorization: string, commandsRequest: services.datastore.v1.CommandsRequest): Promise<services.datastore.v1.CommandsResponse>;
        /**
         ...
         */
        callQueuedResultV1(authorization: string, queuedResultId: string, maxResults?: number, nextToken?: string): Promise<ApiResponse>;
        /**
         * Query statuses of deliveries to offline devices returned by commands API.
         * @param {string} authorization
         * @param {string} queuedResultId A unique identifier to query result for queued delivery for offline devices (DEVICE_UNAVAILABLE).
         ...
         * @param {string} nextToken The value of nextToken in the response to fetch next page. If not specified, the request fetches result for the first page.
         */
        queuedResultV1(authorization: string, queuedResultId: string, maxResults?: number, nextToken?: string): Promise<services.datastore.v1.QueuedResultResponse>;
    }
}
export declare namespace services.deviceAddress {
    /**
